-- ==============================================================================
-- TeleCaller CRM Enterprise — Migration 007: Fix Follow-up scheduled_at Timestamp Cast
-- Explicit TIMESTAMPTZ construction for standalone and embedded follow-ups
-- ==============================================================================
...
BEGIN
  ...
  IF p_follow_up IS NOT NULL AND p_follow_up->>'dueDate' IS NOT NULL THEN
    ...
    INSERT INTO public.follow_ups (
      ...
      v_fu_id, p_org_id, p_lead_id, p_telecaller_id, to_timestamp(v_due_date::TEXT || ' ' || v_due_time, 'YYYY-MM-DD HH12:MI AM'), v_due_date, v_due_time, v_fu_note, v_fu_status, v_now
    );
...
BEGIN
  ...
  INSERT INTO public.follow_ups (
    ...
    v_fu_id, p_org_id, p_lead_id, p_telecaller_id, to_timestamp(p_due_date::TEXT || ' ' || COALESCE(p_due_time, '04:00 PM'), 'YYYY-MM-DD HH12:MI AM'), p_due_date, COALESCE(p_due_time, '04:00 PM'), p_note, v_status, v_now
  );
